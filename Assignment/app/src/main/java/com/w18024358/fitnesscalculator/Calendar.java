    ...
    private void openSelectedDate()
    {
        ...
        if(calorieActivity())
        {
            ...
            if(dateSaved.contains(userSelectedDate))
            {
                ...
                else if(breakfast.containsKey(userSelectedDate))
                {
                ...
                if(lunchData == null || lunchInfo == null || lunch == null) return;
                else if(lunch.containsKey(userSelectedDate))
                {
                ...
                if(dinnerData == null || dinnerInfo == null || dinner == null) return;
                else if(dinner.containsKey(userSelectedDate))
                {
                    //Making sure the message is not displayed (i.e., the user selected a non valid date first then selected a valid date)
                    getMessage().setVisibility(View.INVISIBLE);
                ...
                if(snacksData == null || snacksInfo == null || snacks == null) return;
                else if(snacks.containsKey(userSelectedDate))
                {
                    //Making sure the message is not displayed (i.e., the user selected a non valid date first then selected a valid date)
                    getMessage().setVisibility(View.INVISIBLE);
